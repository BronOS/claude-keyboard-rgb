...
**Data encoding** (corrected 2026-09-11 from upstream `aula/stream.py`): a stream of color groups `R G B count idx1..idxN`, repeated until the data ends; groups may span fragment boundaries. LEDs not mentioned are left as they were. The earlier "(brightness, led_index) pairs" description was wrong: sending `[255, led, 255, led, ...]` is parsed as R=255 G=led B=255 → magenta.
